...
public class InvoiceTest {
    ...
    @Test
    public void testInvoiceHasAutoGeneratedNumber() {
        Invoice firstInvoice = new Invoice();
        Invoice secondInvoice = new Invoice();
        Invoice thirdInvoice = new Invoice();

        int firstNumber = firstInvoice.getNumber();
        int secondNumber = secondInvoice.getNumber();
        int thirdNumber = thirdInvoice.getNumber();

        Assert.assertTrue(firstNumber > 0);
